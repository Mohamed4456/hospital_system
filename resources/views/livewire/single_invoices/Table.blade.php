        ...
        @foreach ($single_invoices as $single_invoice)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{$single_invoice->id}}"  wire:click="delete({{ $single_invoice->id }})"><i class="fa fa-trash"></i></button>
